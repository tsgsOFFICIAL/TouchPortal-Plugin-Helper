...
namespace TouchPortal_Plugin_Helper
{
    public partial class Edit : Page
    {
        ...
        private /*async*/ void TextBlock_Drop(object sender, DragEventArgs e)
        {
            ...
            {
                MessageBox.Show("The import feature does not work atm. Hang tight\n\n-tsgsOFFICIAL", "TouchPortal Plugin Helper", MessageBoxButton.OK, MessageBoxImage.Error);
        ...
        private string CheckFileType(string FullFileName)
        {
            try
            {
                ...
                return Extension.ToLower(); //Return the extension
            }
            catch (Exception)
            {
                return "folder";
